...
export default function(){
    ...
    const detail =  {
                    ...
                    columns: [{field:'DicList_ID',title:'DicList_ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'DicName',title:'数据源value',type:'string',width:100,edit:{type:'text'},align:'left'},
                       {field:'Color',title:'数据源颜色',type:'string',width:140,edit:{type:'text'},align:'left'},
                       {field:'OrderNo',title:'排序号',type:'int',width:80,edit:{type:'text'},align:'left'},
                       {field:'Remark',title:'备注',type:'string',width:90,edit:{type:'text'},align:'left'},
                       {field:'Enable',title:'是否可用',type:'byte',bind:{ key:'enable',data:[]},width:80,edit:{type:'switch'},align:'left'},
                       {field:'CreateID',title:'CreateID',type:'int',width:90,hidden:true,align:'left'},
